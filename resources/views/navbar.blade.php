...
<head>
	...
	<link rel="stylesheet" href="{{ URL::asset('assets/css/theme-floyd.css')}}">
	<link rel="stylesheet" href="{{ URL::asset('assets/css/theme-helper.css')}}">
	<link rel="stylesheet" href="../assets/css/other.css">
<!-- 	<link rel="stylesheet" href="{{ URL::asset('assets/plugins/datatable/dataTables.bootstrap.min.css')}}" />
	<link rel="stylesheet" href="{{ URL::asset('assets/css/styleTambahan.css')}}"/> -->
		...
		<div id="sidebar">
			<div id="sidebar-wrapper">
				...
				<ul class="sidebar-nav">
					...
					<li class="{{ $page == "home" ? "active" : "" }}"><a href="{{ route('home') }}"><i class="fa fa-fw fa-star"></i><span>Beranda</span></a></li>
					<li class="{{ $page == "dok" ? "active" : "" }}"><a href="{{route('dok.index')}}"><i class="fa fa-fw fa-archive"></i><span>Dokumen Skripsi</span></a></li>
					<li class="{{ $page == "kata" ? "active" : "" }}"><a href="{{route('kata.index')}}"><i class="fas fa-fw fa-list"></i><span>Kata Unik</span></a></li>
					<li class="{{ $page == "cluster" ? "active" : "" }}"><a href="{{route('cluster')}}"><i class="fas fa-fw fa-tablet"></i><span>Pengelompokkan</span></a></li>
					<li class="{{ $page == "test" ? "active" : "" }}"><a href="{{route('dok.index')}}"><i class="fas fa-fw fa-check"></i><span>Pengujian</span></a></li>
					<li class="{{ $page == "craw" ? "active" : "" }}"><a href="{{route('dok.index')}}"><i class="fa fa-fw fa-wrench"></i><span>Crawling</span></a></li>
				</ul>
